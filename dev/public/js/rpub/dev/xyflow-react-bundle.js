...
function Wrapper({ children: children2, nodes, edges, defaultNodes, defaultEdges, width, height, fitView, nodeOrigin, nodeExtent }) {
  ...
  return jsx(ReactFlowProvider, { initialNodes: nodes, initialEdges: edges, defaultNodes, defaultEdges, initialWidth: width, initialHeight: height, fitView, nodeOrigin, nodeExtent, children: children2 });
}
var wrapperStyle = {
  width: "100%",
  height: "100%",
...
function ViewportPortal({ children: children2 }) {
  ...
  return createPortal(children2, viewPortalDiv);
}
function useUpdateNodeInternals() {
  const store = useStoreApi();
  return useCallback((id2) => {
...
function useInternalNode(id2) {
  const node = useStore(useCallback((s) => s.nodeLookup.get(id2), [id2]), shallow$1);
  return node;
}
...
function NodeToolbar({ nodeId, children: children2, className, style: style2, isVisible, position = Position.Top, offset = 10, align = "center", ...rest }) {
  const contextNodeId = useNodeId();
  const nodesSelector2 = useCallback((state) => {
